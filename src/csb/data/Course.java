...
public class Course {
    ...
    public HashMap<LocalDate, Lecture> getLectureItemMappings() {
        // GET THE SCHEDULE ITEM DATES FOR QUICK LOOKUP
        HashMap<LocalDate, Lecture> lectureDates = new HashMap();
        for (Lecture lecture : lectures) {
            lectureDates.put(lecture.getDate(),lecture);
        }
        return lectureDates;
    }
    public HashMap<LocalDate, Assignment> getHwItemMappings() {
        // GET THE SCHEDULE ITEM DATES FOR QUICK LOOKUP
        HashMap<LocalDate, Assignment> hwDates = new HashMap();
        for (Assignment hwItem : assignments) {
            hwDates.put(hwItem.getDate(), hwItem);
        }
        return hwDates;
    }
